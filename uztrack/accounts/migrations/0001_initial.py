...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'accounts_profile_groups')
        ...
        m2m_table_name = db.shorten_name(u'accounts_profile_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm[u'accounts.profile'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'accounts_profile_groups'))

        # Removing M2M table for field user_permissions on 'Profile'
        db.delete_table(db.shorten_name(u'accounts_profile_user_permissions'))
