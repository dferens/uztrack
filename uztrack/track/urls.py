...
urlpatterns = patterns('',
    ...
    url(r'^track/(?P<pk>\d+)/$', views.TrackedWayDetailView.as_view(), name='trackedway-detail'),
    url(r'^track/(?P<pk>\d+)/edit/$', views.TrackedWayEditView.as_view(), name='trackedway-edit'),
)
