...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackedWay.departure_date'
        db.add_column(u'track_trackedway', 'departure_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackedWay.departure_date'
        db.delete_column(u'track_trackedway', 'departure_date')
