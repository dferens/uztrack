...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackedWay.dep_max_time'
        db.add_column(u'track_trackedway', 'dep_max_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'TrackedWay.arr_min_time'
        db.add_column(u'track_trackedway', 'arr_min_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'TrackedWay.arr_max_time'
        db.add_column(u'track_trackedway', 'arr_max_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackedWay.dep_max_time'
        db.delete_column(u'track_trackedway', 'dep_max_time')

        # Deleting field 'TrackedWay.arr_min_time'
        db.delete_column(u'track_trackedway', 'arr_min_time')

        # Deleting field 'TrackedWay.arr_max_time'
        db.delete_column(u'track_trackedway', 'arr_max_time')
    ...
    models = {
        ...
        u'track.trackedway': {
            ...
            'arr_max_time': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            'arr_min_time': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            'days': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'dep_max_time': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            'dep_min_time': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
