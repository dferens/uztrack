...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column(u'track_trackedway', 'start_time', self.gf('django.db.models.fields.TimeField')(null=True))
        db.rename_column(u'track_trackedway', 'start_time', 'dep_min_time')

    def backwards(self, orm):
        db.alter_column(u'track_trackedway', 'dep_min_time', self.gf('django.db.models.fields.TimeField')())
        db.rename_column(u'track_trackedway', 'dep_min_time', 'start_time')
