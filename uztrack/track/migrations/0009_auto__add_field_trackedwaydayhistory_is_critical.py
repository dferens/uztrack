...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackedWayDayHistory.is_critical'
        db.add_column(u'track_trackedwaydayhistory', 'is_critical',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackedWayDayHistory.is_critical'
        db.delete_column(u'track_trackedwaydayhistory', 'is_critical')
    ...
    models = {
        ...
        u'track.trackedway': {
            ...
            'arr_max_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            'arr_min_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            'days': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'dep_max_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            'dep_min_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'track.trackedwaydayhistory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_critical': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
