...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistorySubscription'
        db.create_table(u'track_historysubscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('history', self.gf('annoying.fields.AutoOneToOneField')(related_name='subscription', unique=True, to=orm['track.TrackedWayDayHistory'])),
        ))
        db.send_create_signal(u'track', ['HistorySubscription'])


    def backwards(self, orm):
        # Deleting model 'HistorySubscription'
        db.delete_table(u'track_historysubscription')
    ...
    models = {
        ...
        u'track.historysubscription': {
            'Meta': {'object_name': 'HistorySubscription'},
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'history': ('annoying.fields.AutoOneToOneField', [], {'related_name': "'subscription'", 'unique': 'True', 'to': u"orm['track.TrackedWayDayHistory']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'track.trackedway': {
